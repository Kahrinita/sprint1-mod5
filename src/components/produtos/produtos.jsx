...
const Produtos = () => {
  ...
  useEffect(()=>{
    const api = `https://frontend-intern-challenge-api.iurykrieger.now.sh/products?page=1`
  ...
  return ( 
    <div className='Produtos'>
      ...
      <Button onClick={()=> {adicionaProdutos(page)}} btexto='Ainda mais produtos aqui!'/>
      </div>
    </div>
   );
}
